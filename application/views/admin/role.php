                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button href onclick="hapusRole('<?= base_url('admin/hapusrole/') . $r['id']; ?>')" class="badge badge-danger badge-sm tombol-hapus">Delete</button>
...
<!--Modal edit-->
<?php foreach ($role as $r) : ?>
    <div class="modal fade" id="roleedit<?= $r['id']; ?>" tabindex="-1" aria-labelledby="roleedit" aris-hidden="true">
