                ...
                <tbody>
                    ...
                    <?php foreach ($SubMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#exampleModalsubedit<?= $sm['id']; ?>">Edit</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newMenuMokdalLabel">Add sub Menu</h5>
            ...
            <form action="<?= base_url('menu/submenu'); ?>" method="post">
                ...
                <div class="form-group">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" name="is_active" id="is_active" aria-label="Checkhbox for following text input" checked>
...
<!-- Modal edit-->
<?php foreach ($SubMenu as $sm) : ?>
    <div class="modal fade" id="exampleModalsubedit<?= $sm['id']; ?>" tabindex="1" aria-labelLedby="examplewModalLabelsubedit" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="examplewModalLabelsubedit">Edit subMenu</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
